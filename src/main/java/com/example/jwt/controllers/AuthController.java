...
public class AuthController {
    //se utiliza para validar la autenticación, por lo que este puede ser un pequeño truco útil para
    // obtener una referencia de tipo seguro a sus datos de usuario
    @Autowired
